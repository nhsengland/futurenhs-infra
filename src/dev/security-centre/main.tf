## Commented out because this all needs to be taken out of this set of scripts and moved into 
## the subscription wide configuration to support multiple environments in the same subscription
## which we'll pick up when refactoring
